...
export function Signup(){
    ...
    return <div className="h-screen w-screen flex justify-center items-center">
        <div className="h-96 w-80 border shadow-md rounded-xl p-8">
            ...
            <div className="ml-12 m-3"><Button title="Signup" variant="primary" size="sm" fun={signup}/></div>
            <h1 className="mt-12 ml-3.5">Already have an account? <Link to="/signin">Signin</Link></h1>
        </div>
    </div>
}